 ...
 */
async function runDevicectl(args: string[], timeout = 180000) {
...
export async function listConnectedDevices(): Promise<DeviceListResult> {
  ...
  for (const line of lines) {
    if (!line || line.toLowerCase().includes('identifier')) continue;
 ...
 */
export async function installApp(deviceUdid: string, appPath: string): Promise<DeviceActionResult> {
 ...
 */
export async function terminateApp(deviceUdid: string, bundleId: string): Promise<DeviceActionResult> {
 ...
 */
export async function uninstallApp(deviceUdid: string, bundleId: string): Promise<DeviceActionResult> {
 ...
 */
export async function takeScreenshot(deviceUdid: string, outputPath: string): Promise<ScreenshotResult> {
